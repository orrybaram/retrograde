...
- **Freight** is never lost. Unclamped, it parks: momentum bleeds to a full stop, gravity does not move it, and nothing but the ship ever carries it anywhere. A clamp will not hold past the edge of the **Void**, so all Freight is always inside the system.
